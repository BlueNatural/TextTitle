...
public class TitleMarcus {
public static TextTitle plugin;
	...
	public TitleMarcus(String title) {
		this.title = title;
		loadClasses();
	}

	public TitleMarcus(String title, String subtitle) {
		this.title = title;
		this.subtitle = subtitle;
		loadClasses();
	}

	public TitleMarcus(TitleMarcus title) {
	...
	public TitleMarcus(String title, String subtitle, int fadeInTime, int stayTime, int fadeOutTime) {
		this.title = title;
		this.subtitle = subtitle;
	...
	public static void sendTitle(Player player, String title, String subtitle, Integer fadeIn, Integer stay,
		...
		try {
	       ...
	       TextTitle.plugin.getServer().getPluginManager().callEvent(new SendingTitleEvent(player,title,subtitle));
	...
	public static void sendSubtitle(Player p,String subtitle,int fadein,int stay,int fadeout) {
		...
		TextTitle.plugin.getServer().getPluginManager().callEvent(new SendingTitleEvent(p,null,subtitle));
	...
	public static void animationTitle(Player p,String title,String subtitle,int fadein,int stay,int fadeout,int count,int delay) throws InterruptedException {
		...
		for(int i = 0;i < count;i++) {
		   ...
		   TextTitle.plugin.getServer().getPluginManager().callEvent(new SendingTitleEvent(p,title,subtitle));
		}
